...
export default function Contact() {
  ...
  return (
    <section id="contact" aria-labelledby="contact-heading" className="py-24 relative px-6">
      {/* Decorative elements */}
      <motion.div
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <MotionWrapper className="text-center mb-16">
          ...
          <h2 id="contact-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mt-2 mb-4">
