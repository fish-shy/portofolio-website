    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-green-400">Hafiz Nazwa</h3>
            <p className="text-gray-400 leading-relaxed max-w-sm">
              Full Stack Developer crafting innovative web solutions with passion and precision. Always learning, always growing.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#skills" className="text-gray-400 hover:text-green-400 transition-colors">
                  Skills
                </a>
              </li>
              <li>
